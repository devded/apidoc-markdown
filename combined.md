...
<details>
 <summary style="padding: 10px; font-size: 17px; background-color: #faeeed;">API 01: Create User</summary>

#### Endpoint :

```text
https://github.com/rigwild/apidoc-markdown/blob/master/exam
```
...
<details>
###<summary><b> API 01:  Create User</b></summary>
